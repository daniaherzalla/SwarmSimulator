...
def mktext(text, font, color):
    ...
    """
    return font[0].render(text, fgcolor=color, size=font[1])
...
class Message(pygame.sprite.Sprite):
    ...
    def __init__(self, pos, text="", font=params.BODY_FONT, color=params.FONT_COLOR_MENU):
        super().__init__()
        self._text = text
        self.font = font
        self.image, self.rect = mktext(text, font, color)
    ...
    def set_text(self, text):
        self._text = text
        self.image, rect = mktext(text, self.font, color=params.FONT_COLOR_MENU)
...
class TempMessage(Message):
    ...
    def __init__(self, pos, text="", font=params.H4_FONT, duration=3):
...
class Button(Message):
    ...
    def __init__(self, pos, text="", font=params.BODY_FONT, color=params.FONT_COLOR, action=None):
        super().__init__(pos, text, font)
...
class ToggleButton(Button):
    ...
    def __init__(self, pos, text="", font=params.H5_FONT,
